...
export default function MobileExportBar() {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <a
        href="https://github.com/wangyz1999/3d-emoji-assets-generator?tab=readme-ov-file#download-pre-generated-assets"
        target="_blank"
        rel="noopener noreferrer"
        className="flex items-center justify-center gap-1.5 rounded-lg border border-zinc-700 bg-zinc-800 px-3 py-2 text-xs font-semibold text-zinc-300 transition-all hover:border-zinc-500 hover:bg-zinc-700 hover:text-white"
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        Download 4,000+ Pre-generated Emojis
      </a>
    </div>
  );
}
